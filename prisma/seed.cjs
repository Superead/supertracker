...
async function main() {
  await prisma.user.upsert({
    where: { email: "admin@superead.com" },
    update: {},
    create: {
  ...
  // ═══════════════════════════════════════════
  // SUPEREAD YAZILIM EĞİTİMİ PAKETLERİ
  // ═══════════════════════════════════════════
  ...
  // ═══════════════════════════════════════════
  // SUPEREAD - ESKİ KAYIT YENİLEME / 3 AYLIK
  // ═══════════════════════════════════════════
  ...
  const superYenilemePackages = [
    ...
    { name: "2 Kişi - Kayıt Yenileme (2.749 TL)", personCount: 2, duration: "yearly", basePrice: 2749,
      paymentLinkPayTR: null,
      paymentLinkSuperead: "https://pay.superead.com/link/cNEfWpE7" },
    { name: "1 Kişi - Ömür Boyu Yenileme", personCount: 1, duration: "lifetime", basePrice: 0,
      paymentLinkPayTR: "https://www.paytr.com/link/XMUw7AG",
      paymentLinkSuperead: null },
    { name: "2 Kişi - 3 Aylık (3.249 TL)", personCount: 2, duration: "3month", basePrice: 3249,
      paymentLinkPayTR: null,
      paymentLinkSuperead: "https://pay.superead.com/link/nOTLfi94" },
  ];
