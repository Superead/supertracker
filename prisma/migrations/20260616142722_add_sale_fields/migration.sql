...
INSERT INTO "new_Sale" ("createdAt", "customerNote", "customerType", "deletedAt", "discount", "discountReason", "id", "isDeleted", "packageId", "quantity", "totalPrice", "unitPrice", "updatedAt", "userId") SELECT "createdAt", "customerNote", "customerType", "deletedAt", "discount", "discountReason", "id", "isDeleted", "packageId", "quantity", "totalPrice", "unitPrice", "updatedAt", "userId" FROM "Sale";
DROP TABLE "Sale";
